...
def train_and_evaluate(create_train_reader, test_reader, network_name, epoch_size, max_epochs, create_dist_learner, scale_up=False):
...
if __name__=='__main__':
    ...
    epoch_size = 50000
    train_and_evaluate(create_train_reader, test_reader, network_name, epoch_size, epochs, create_dist_learner, scale_up)
